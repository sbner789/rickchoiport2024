                    ...
                    [
                        {
                            ...
                            proMainPoint: "회사 내 개발한 다양한 XR 게임 컨텐츠를 보다 쉽게 실행 할 수 있고 대회 일정 관리 및 대회 참여를 Web Desktop application 을 통해 실시간으로 확인 및 참여를 할 수 있게 개발을 하였습니다. 기존 회사에서 운용 중인 게임 런처는 실시간 데이터를 처리 할 수 없는 환경이라 개발사와 클라이언트 간 소통이 원활하지 못한 점에서 한계를 느껴 개발 하였습니다. 기존 방식에서 탈피하여 웹 클라이언트를 적용, 게임 컨텐츠에 맞는 UI/UX 를 통해 사용자 경험을 이끌어 냈으며 빠른 통신과 대회 진행에 문제가 되지않게 하는 것을 목표로 개발 하였습니다.",
                            proIcons: [
                                {
                                    seq: 0,
                                    icon: html5Icon,
